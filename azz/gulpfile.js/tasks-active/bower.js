...
gulp.task('bower', ['bower-normalize','bower-jssorSlider']);
...
gulp.task('bower-jssorSlider', function() {
  return gulp.src(config.src+'jssor-slider/js/jssor.slider.mini.js')
  .pipe(plugins.changed(config.destJS))
