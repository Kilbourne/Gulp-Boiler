...
var project     = 'azzurro'
  ...
  , composer    = './vendor/'
  ,all          = [src+'leaguemanager.js',src+'js/flowtype.js',src+'js/scripts.js',src+'js/jssor.js',src+'js/jssor.slider.js',src+'js/jquery.magnific-popup.min.js']
;
...
module.exports = {
  ...
  , chunks: { // Chunks are arrays of globs matching source files that combine to provide specific functionality
      core: all,
      media:all.concat([src+'js/bwg_frontend.js',src+'js/bwg_gallery_box.js',src+'js/jquery.fullscreen-0.4.1.js',src+'js/jquery.mCustomScrollbar.concat.min.js',src+'js/jquery.mobile.js',src+'js/srizon.custom.min.js',src+'js/mag-popup.js'])
    }
  ...
  , compiler: 'ruby-sass' // Choose a Sass compiler: 'libsass' or 'ruby-sass'
